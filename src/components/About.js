...
const About = () => {
    return (
        <div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="section_title_container text-center">
                                <h2 class="section_title">Welcome To Beauty E-Learning</h2>
            ...
            <div class="feature">
                <div class="feature_background" style={{backgroundImage:"url(images/courses_background.jpg)"}}></div>
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="section_title_container text-center">
                    ...
                    <div class="row feature_row">
                        ...
                        <div class="col-lg-6 feature_col">
                            <div class="feature_video d-flex flex-column align-items-center justify-content-center">
                                <div class="feature_video_background" style={{backgroundImage:"url(images/video.jpg)"}}></div>
